...
export const crewMembers: CrewMember[] = [
    {
        ...
        summary: 'Helps identify security combinations',
        cost: __DEV__ ? 1 : 5000, // 5000
    ...
    },
    {
        ...
        effect: 'When Tico is on the crew, the payoff tends to be bigger than expected.',
        summary: 'Increases the bonus pay of Act One',
        cost: __DEV__ ? 1 : 5000, // 5000
    ...
    },
    {
        ...
        summary: 'Increased perfect crack margin',
        cost: __DEV__ ? 1 : 7500, // 7500
    ...
    },
    {
        ...
        summary: 'Have the police ever caught you with Fingers on the crew?',
        cost: __DEV__ ? 1 : 10000, // 10000
    ...
    },
    {
        ...
        summary: 'Walk away with more loot when caught',
        cost: __DEV__ ? 1 : 7500, // 7500
